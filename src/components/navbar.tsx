export default function Navbar() {
  ...
  const NEXT_PUBLIC_APP_TOPPAGE_PATH = process.env.NEXT_PUBLIC_APP_TOPPAGE_PATH;
  const NEXT_PUBLIC_APP_NAME = process.env.NEXT_PUBLIC_APP_NAME;
  const NEXT_PUBLIC_APP_LOGO_URL = process.env.NEXT_PUBLIC_APP_LOGO_URL;
    ...
    <>
      ...
      <nav
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href={NEXT_PUBLIC_APP_TOPPAGE_PATH} className="flex items-center space-x-3 rtl:space-x-reverse">
            {NEXT_PUBLIC_APP_LOGO_URL != "" &&
              <>
                <img src={NEXT_PUBLIC_APP_LOGO_URL} className="h-8" alt={`${NEXT_PUBLIC_APP_NAME} logo`} />
              </>
            }
            <span className="self-center text-normal font-semibold whitespace-nowrap">{NEXT_PUBLIC_APP_NAME}</span>
          </a>
